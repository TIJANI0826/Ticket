...
class Laundry(models.Model):
    ...
    def total(self):
        ...
        if self.commission != '':
            commission_present = 100
        return (self.shirt*100) + (self.towel*100) + (self.trouser*100) + (self.underwear*100) + (self.native*200) + (self.duvet*200) + (self.duver_beddings*200) + (commission_present)
